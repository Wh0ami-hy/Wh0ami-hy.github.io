...
idea里面提供了两套模板Live Templates和Postfix Completion。Live Templates 可以自定义，而 Postfix Completion 不可以。Postfix Completion实现：可以跟在一个变量后面进行快速生成语句
 ...
 * @Author HouYi  
 * @Date $date$ $time$  
 * @Doc This is description of class   
 */
```
 ...
 * @Author HouYi  
 * @Date $date$ $time$  
 * @Doc This is description of method  
 * @Param $params$  
 * @Return $return$  
 */
```
